...
* Y-Axis lable: Count
* Color: from a custom palette using orange to white
...
* X-Axis lable: Education Level
* Y-Axis lable: Count
* Color: from a custom palette using purple to white
...
* Scope: Only the first 20 lines from the data frame should be used
...
* Scope: This data frame is small so do not restrict the number of lines used
* Title: Heat Map
* X-axis label: Meal
* Y-axis label: Day
* Rowv/Colv symbols: NA
...
Create a mosaic plot for the [infert] data frame. The plot should meet these specifications:
