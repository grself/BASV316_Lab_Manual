...
```{r ex="act06.01", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r ex="act06.01", type="sample-code"}
...
```{r fig.width=5.5,fig.height=4,fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
* Line 2: This line creates a custom palette named `colpal` (for “color palette”), which is, essentially, a new _R_ command that creates color codes for plots. In this case, the function will create the codes for color gradients between blue and white. _Note: While any two colors can be specified for colorRampPalette, only one hue should be selected along with either white or black in order to make plots more usable for readers who are color blind._
...
```{r ex="ex06.02", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="ex06.02", type="sample-code"}
# Create a clustered bar plot for infert using the specifications listed above.


```

```{r ex="ex06.02", type="solution"}
...
```{r ex="act06.02", type="pre-exercise-code"}
...
```{r fig.width=3,fig.height=3,fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
```{r ex="ex06.03", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="ex06.03", type="sample-code"}
# Create a stacked bar plot for infert using the specifications listed above.


```

```{r ex="ex06.03", type="solution"}
...
```{r ex="act06.03", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r ex="act06.03", type="sample-code"}
...
```{r fig.width=4,fig.height=4,fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
```{r ex="ex06.04", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="ex06.04", type="sample-code"}
# Create a pie chart for states.division using the specifications listed above.


```

```{r ex="ex06.04", type="solution"}
...
```{r ex="act06.04", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r ex="act06.04", type="sample-code"}
...
```{r ex="ex06.05", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="ex06.05", type="sample-code"}
# Create a heat map for attitude using the specifications listed above.


```

```{r ex="ex06.05", type="solution"}
...
```{r ex="act06.05", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r ex="act06.05", type="sample-code"}
...
```{r fig.width=3.5,fig.height=4,fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
```{r ex="ex06.06", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="ex06.06", type="sample-code"}
# Create a mosaic plot for infert using the specifications listed above.

```

```{r ex="ex06.06", type="solution"}
...
```{r ex="act06.06", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r ex="act06.06", type="sample-code"}
