...
```{r 07.02, fig0601,fig.width=3.5,fig.height=4,out.width="40%", fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
Using the [stackloss] data frame, create a bar plot for _Water.Temp_. The plot should: 

* Have a main title of _Water Temperature_
* The X-Axis should have a lable of _Number_
* The Y-Axis should have a lable of _Temperature_
* The color palette should be _cm.colors(9)_

```{r 07.04, ex="ex06.01", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 07.05, ex="ex06.01", type="sample-code"}
# Create a bar plot for Water.Temp using the specifications listed above.


```

```{r 07.06, ex="ex06.01", type="solution"}
...
### Activity 6.1: Bar Plot

Using the [cafe] data frame, create a bar plot for _meal_.  The plot should:

1. Have a title of _Activity 6.1: Bar Plot_
2. The x-axis should have a label of _Meal_
3. The y-axis should have a label of _Count_
4. The color palette should be _topo.colors(4)_

Copy/paste the bar chart in the deliverable document for this lab.

```{r 07.08, ex="act06.01", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 07.09, ex="act06.01", type="sample-code"}
...
```{r 07.10, fig.width=5.5,fig.height=4,fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
_Color_ can be added to a barplot to make it more pleasing and easier to understand. More information can be found in the [About Colors] section in the appendix.
...
Using the [infert] data frame, create a clustered bar plot for _spontaneous_ grouped by _education_. The plot should have: 

* A main title of _Spontaneous Cases by Education Level_
* The X-Axis should have a lable of _Education Level_
* The Y-Axis should have a lable of _Count_
* The colors should be from a custom palette using orange to white
* The legend should have a title of _Spontaneous_

```{r 07.12, ex="ex06.02", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 07.13, ex="ex06.02", type="sample-code"}
# Create a clustered bar plot for infert using the specifications listed above.


```

```{r 07.14, ex="ex06.02", type="solution"}
...
### Activity 6.2: Clustered Bar Plot

Using the [cafe] data frame, create a clustered bar plot that shows the number of people who ate a given _meal_ by _sex_. The plot should have three clusters (male, female, other) and each of those three clusters should have four meals (breakfast, lunch, dinner, other). The plot should: 

* Have a title of _Activity 6.2: Clustered Bar Plot_
* The x-axis should have a label of _Sex_ 
* The y-axis should have a label of _Count_
* The colors should be from a custom palette using dark green to white
* The legend should have a title of _Meal_

Copy/paste the bar chart in the deliverable document for this lab.

```{r 07.16, ex="act06.02", type="pre-exercise-code"}
cafe <- read.csv('http://georgeself.com/maincafe.csv')
```

```{r ex="act06.02", type="sample-code"}
...
```{r 07.17, fig.width=3,fig.height=3,fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
Using the [infert] data frame, create a stacked bar plot for _induced_ grouped by _education_. The plot should: 

* Have a main title of _Induced Cases by Education Level_
* The X-Axis should have a lable of _Education Level_
* The Y-Axis should have a lable of _Count_
* The colors should be from a custom palette using purple to white
* The legend should have a title of _Induced_

```{r 07.19, ex="ex06.03", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 07.20, ex="ex06.03", type="sample-code"}
# Create a stacked bar plot for infert using the specifications listed above.


```

```{r 07.21, ex="ex06.03", type="solution"}
...
### Activity 6.3: Stacked Bar Plot

Using the [cafe] data frame, create a stacked bar chart that shows the number of people who ate a given _meal_ by _sex_. The chart should have three columns (male, female, other) and each of those three columns should have four meals (breakfast, lunch, dinner, other). The chart should:

* Have a title of _Activity 6.3: Stacked Bar Plot_
* The x-axis should have a label of _Sex_ 
* The y-axis should have a label of _Count_
* The colors should be from a custom palette using goldenrod to white
* The legend should have a title of _Meal_

Copy/paste the bar chart in the deliverable document for this lab.

```{r 07.23, ex="act06.03", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 07.24, ex="act06.03", type="sample-code"}
...
```{r 07.25, fig.width=4,fig.height=4,fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
Create a pie chart for the [state.division] data frame. NOTE: This data frame has only one vector so it is not necessary to use the `$` operator. The chart should: 

* Have a main title of _States by Division_
* Nine colors should be used from the topo.colors palette
* The lables should be the same as the _states.division_ vector

```{r 07.27, ex="ex06.04", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 07.28, ex="ex06.04", type="sample-code"}
# Create a pie chart for states.division using the specifications listed above.


```

```{r 07.29, ex="ex06.04", type="solution"}
...
### Activity 6.4: Pie Chart

Using the [cafe] data frame, create a pie chart that shows the number of people who ate a given _meal_ (breakfast, lunch, dinner, other). The chart should:

* Have a title of _Activity 6.4: Pie Chart_
* Use six colors from the terrain color palette
* Include labels for each of the pie slices

Copy/paste the pie chart in the deliverable document for this lab.

```{r 07.31, ex="act06.04", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 07.32, ex="act06.04", type="sample-code"}
...
```{r 07.33,fig.width=4,fig.height=4,fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
```{r 07.34, ex="heatmap", type="pre-exercise-code"}
...
```{r 07.35, ex="heatmap", type="sample-code"}
...
```{r 07.37, ex="ex06.05", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 07.38, ex="ex06.05", type="sample-code"}
# Create a heat map for attitude using the specifications listed above.


```

```{r 07.39, ex="ex06.05", type="solution"}
...
```{r 07.43, fig.width=3.5,fig.height=4,fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
Create a mosaic plot for the [infert] data frame. The plot should have:

* Have a title of _Compare Induced and Education_
* Have an xlab of _Number Induced_
* Have a ylab of _Education Level_ 
* Use five colors from the _terrain.colors_ palette

```{r 07.45, ex="ex06.06", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 07.46, ex="ex06.06", type="sample-code"}
# Create a mosaic plot for infert using the specifications listed above.

```

```{r 07.47, ex="ex06.06", type="solution"}
...
### Activity 6.6: Mosaic Plot

Using the [cafe] dataset, create a mosaic plot that compares the number of people dining at each _meal_ (breakfast, lunch, dinner, other) to the rating for service (_svc_). The plot should:

* Have a title of _Activity 6.6: Mosaic_
* Have an xlab of _Meal_
* Have a ylab of _Service_
* Use five colors from the _terrain.colors_ palette

Copy/paste the mosaic plot in the deliverable document for this lab.

```{r 07.49, ex="act06.06", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 07.50, ex="act06.06", type="sample-code"}
