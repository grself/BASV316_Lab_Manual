...
```{r 020.17, ex="sc020.03", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 020.18, ex="sc020.03", type="sample-code"}
...
```{r 020.19, ex="sc020.03", type="solution"}

mean(attitude$critical, trim=0.15)

```

```{r 020.20, ex="sc020.03", type="sct"}
...
```{r 020.21, ex="act020.03", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 020.22, ex="act020.03", type="sample-code"}
...
```{r 020.24, ex="sc020.04", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 020.25, ex="sc020.04", type="sample-code"}
...
```{r 020.26, ex="sc020.04", type="solution"}

median(attitude$critical)

```

```{r 020.27, ex="sc020.04", type="sct"}
...
```{r 020.28, ex="act020.04", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 020.29, ex="act020.04", type="sample-code"}
...
```{r 020.30, echo=FALSE, message=FALSE, warnings=FALSE, results='asis', tut=FALSE}
