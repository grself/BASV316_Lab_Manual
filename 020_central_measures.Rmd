...
```{r 02.03, ex="ex02.01", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 02.04, ex="ex02.01", type="sample-code"}
...
```{r 02.05, ex="ex02.01", type="solution"}

length(attitude$critical)

```

```{r 02.06, ex="ex02.01", type="sct"}
...
```{r 02.07, ex="act02.01", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 02.08, ex="act02.01", type="sample-code"}
...
```{r 02.10, ex="ex02.02", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 02.11, ex="ex02.02", type="sample-code"}
...
```{r 02.12, ex="ex02.02", type="solution"}

mean(attitude$critical)

```

```{r 02.13, ex="ex02.02", type="sct"}
...
```{r 02.14, ex="act02.02", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 02.15, ex="act02.02", type="sample-code"}
...
```{r 02.17, ex="ex02.03", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 02.18, ex="ex02.03", type="sample-code"}
...
```{r 02.19, ex="ex02.03", type="solution"}

mean(attitude$critical, trim=0.15)

```

```{r 02.20, ex="ex02.03", type="sct"}
...
```{r 02.21, ex="act02.03", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 02.22, ex="act02.03", type="sample-code"}
...
```{r 02.24, ex="ex02.04", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 02.25, ex="ex02.04", type="sample-code"}
...
```{r 02.26, ex="ex02.04", type="solution"}

median(attitude$critical)

```

```{r 02.27, ex="ex02.04", type="sct"}
...
```{r 02.28, ex="act02.04", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 02.29, ex="act02.04", type="sample-code"}
...
```{r 02.30, cyltable, echo=FALSE, message=FALSE, warnings=FALSE, results='asis', tut=FALSE}
