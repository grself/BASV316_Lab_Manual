...
```{r 200.08, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c("Ozone", 
    "Solar.R", 
    "Wind",
...
```{r 200.09, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "event", 
    "mag", 
...
```{r 200.10, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "ratings", 
    "complaints", 
...
```{r 200.11, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "day", 
    "time", 
...
```{r 200.12, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "sex", 
    "age", 
...
```{r 200.13, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "speed", 
    "dist"
...
```{r 200.14, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "weight", 
    "Time",
...
```{r 200.15, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "weight", 
    "feed"
...
```{r 200.16, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "Plant", 
    "Type", 
...
```{r 200.17, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "agegp", 
    "alcgp", 
...
```{r 200.18, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "eruptions", 
    "waiting"
...
```{r 200.19, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "education", 
    "age", 
...
```{r 200.20, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "Sepal.Length", 
    "Sepal.Width", 
...
```{r 200.21, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "GNP.deflator", 
    "GNP", 
...
```{r 200.22, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "Expt", 
    "Run", 
...
```{r 200.23, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "mpg", 
    "cyl", 
...
```{r 200.24, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "block", 
    "N", 
...
```{r 200.25, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "weight", 
    "group" 
...
```{r 200.26, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "area", 
    "peri",
...
```{r 200.27, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "extra", 
    "group",
...
```{r 200.28, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "Air Flow", 
    "Water Temp",
...
```{r 200.29, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "Fertility", 
    "Agriculture", 
...
```{r 200.30, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Num = c(
    "1", 
    "2", 
...
```{r 200.31, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "Girth", 
    "Height",
...
```{r 200.32, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Num = c(
    "1", 
    "2",
...
```{r 200.33, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "Murder", 
    "Assault",
...
```{r 200.34, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "CONT", 
    "INTG",
...
```{r 200.35, tut=FALSE, echo=FALSE, message=FALSE, warnings=FALSE}
cor_tbl <- data.frame(
  Name = c(
    "breaks", 
    "wool",
