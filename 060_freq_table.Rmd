...
```{r 06.04, ex="ex05.01", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 06.05, ex="ex05.01", type="sample-code"}
# Create a frequency table for feed in the chickwts data frame.


```

```{r 06.06, ex="ex05.01", type="solution"}

table(chickwts$feed)

```

```{r 06.07, ex="ex05.01", type="sct"}
...
```{r 06.08, ex="act05.01", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 06.09, ex="act05.01", type="sample-code"}
...
```{r 06.12, ex="ex05.02", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 06.13, ex="ex05.02", type="sample-code"}
# Create a frequency table with margins for feed in the chickwts data frame.


```

```{r 06.14, ex="ex05.02", type="solution"}

addmargins(table(chickwts$feed))

```

```{r 06.15, ex="ex05.02", type="sct"}
...
```{r 06.16, ex="act05.02", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 06.17, ex="act05.02", type="sample-code"}
...
```{r 06.20, ex="ex05.03", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 06.21, ex="ex05.03", type="sample-code"}
# Create a proportion table for feed in the chickwts data frame.


```

```{r 06.22, ex="ex05.03", type="solution"}

prop.table(table(chickwts$feed)) * 100

```

```{r 06.23, ex="ex05.03", type="sct"}
...
```{r 06.24, ex="act05.03", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 06.25, ex="act05.03", type="sample-code"}
...
```{r 06.29, ex="ex05.04", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 06.30, ex="ex05.04", type="sample-code"}
# Create a crosstabs table for tobgp and alcgp in the esoph data frame.

```

```{r 06.31, ex="ex05.04", type="solution"}

xtabs(~esoph$tobgp+esoph$alcgp)

```

```{r 06.32, ex="ex05.04", type="sct"}
...
```{r 06.33, ex="act05.04", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 06.34, ex="act05.04", type="sample-code"}
...
```{r 06.38, ex="ex05.05", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 06.39, ex="ex05.05", type="sample-code"}
# Create a crosstabs table for tobgp, alcgp, and agegp in the esoph data frame.

```

```{r 06.40, ex="ex05.05", type="solution"}

xtabs(~tobgp+alcgp+agegp, data=esoph)

```

```{r 06.41, ex="ex05.05", type="sct"}
...
```{r 06.42, ex="act05.05", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 06.43, ex="act05.05", type="sample-code"}
...
```{r 06.47, ex="ex05.06", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 06.48, ex="ex05.06", type="sample-code"}
# Create a calculated crosstab for the mean yield for N, P, and K in the npk data frame.


```

```{r 06.49, ex="ex05.06", type="solution"}

aggregate(yield~N+P+K, data = npk, FUN = mean)

```

```{r 06.50, ex="ex05.06", type="sct"}
...
```{r 06.51, ex="act05.06", type="pre-exercise-code"}
cafe <- read.csv('http://georgeself.com/maincafe.csv')
```

```{r 06.52, ex="act05.06", type="sample-code"}
...
```{r 06.54, ex="ex05.07", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 06.55, ex="ex05.07", type="sample-code"}
...
```{r 06.58, ex="act05.07", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 06.59, ex="act05.07", type="sample-code"}
