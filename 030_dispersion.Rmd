...
```{r 03.03, ex="ex03.01", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 03.04, ex="ex03.01", type="sample-code"}
# Range for eruptions
...
```{r 03.05, ex="ex03.01", type="solution"}

range(faithful$eruptions)

```

```{r 03.06, ex="ex03.01", type="sct"}
...
```{r 03.07, ex="act03.01", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 03.08, ex="act03.01", type="sample-code"}
...
```{r 03.10, ex="ex03.02", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 03.11, ex="ex03.02", type="sample-code"}
...
```{r 03.12, ex="ex03.02", type="solution"}

summary(USJudgeRatings$WRIT)

```

```{r 03.13, ex="ex03.02", type="sct"}
...
Using the [cafe] data frame, find the summary for _age_. Include the values for Q1 and Q3 in the deliverable document for this lab.

```{r 03.14, ex="act03.02", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 03.15, ex="act03.02", type="sample-code"}
...
```{r 03.17, ex="ex03.03", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 03.18, ex="ex03.03", type="sample-code"}
...
```{r 03.19, ex="ex03.03", type="solution"}

IQR(swiss$Agriculture)

```

```{r 03.20, ex="ex03.03", type="sct"}
...
```{r 03.21, ex="act3.3", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 03.22, ex="act3.3", type="sample-code"}
...
```{r 03.23, stdevPlot, echo=FALSE, message=FALSE, warnings=FALSE, results='asis', tut=FALSE}
...
```{r 03.25, ex="ex03.04", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 03.26, ex="ex03.04", type="sample-code"}
# Find the standard deviation for Air.Flow


```

```{r 03.27, ex="ex03.04", type="solution"}

sd(stackloss$Air.Flow)

```

```{r 03.28, ex="ex03.04", type="sct"}
...
```{r 03.29, ex="act03.04", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 03.30, ex="act03.04", type="sample-code"}
