...
```{r ex="ex01.01", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="ex01.01", type="sample-code"}
...
```{r ex="act01.01", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="act01.01", type="sample-code"}
...
* Line 4: This line prints the maximum _mpg_ value for the _mtcars_ data frame. Note that the specific vector desired is indicated by both the data frame name and the vector, separated by a dollar sign, like _mtcars$mpg_ on this line.
...
```{r ex="ex01.02", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="ex01.02", type="sample-code"}
...
Using the *cafe* data, find the maximum and minimum values for the *bill* variable and include those values in the deliverable document for this lab.

```{r ex="act01.02", type="pre-exercise-code"}

cafe <- read.csv('http://gself.com/maincafe.csv')

```

```{r ex="act01.02", type="sample-code"}
