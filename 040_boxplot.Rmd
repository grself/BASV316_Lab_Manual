...
```{r 04.02, echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
```{r 04.03,, fig.dim=c(2.5,4.0), fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
```{r 04.04,, fig.dim=c(2.5,4.0), fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
```{r 04.06, ex="ex04.01", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 04.07, ex="ex04.01", type="sample-code"}
# Create a boxplot for Sepal.Length


```

```{r 04.08, ex="ex04.01", type="solution"}

boxplot(iris$Sepal.Length)

```

```{r 04.09, ex="ex04.01", type="sct"}
...
```{r 04.10, ex="act04.01", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 04.11, ex="act04.01", type="sample-code"}
...
```{r 04.12,, fig.dim=c(2.5,4.0), fig.align="center", fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
```{r 04.14, ex="ex04.02", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 04.15, ex="ex04.02", type="sample-code"}
# Use boxplot.stats to see if Sepal.Width has any outliers

```

```{r 04.16, ex="ex04.02", type="solution"}

boxplot.stats(iris$Sepal.Width)

```

```{r 04.17, ex="ex04.02", type="sct"}
...
```{r 04.18, ex="act04.02", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 04.19, ex="act04.02", type="sample-code"}
...
```{r 04.20, fig.dim=c(4.0, 4.0), fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
```{r 04.22, ex="ex04.03", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 04.23, ex="ex04.03", type="sample-code"}
...
```{r 04.24, ex="ex04.03", type="solution"}
...
```{r 04.26, ex="act04.03", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 04.27, ex="act04.03", type="sample-code"}
