...
Using the [cafe] data frame, generate a boxplot for both _age_. Copy/paste the boxplot in the deliverable document for this lab.
...
```{r fig.dim=c(4.0, 4.0), fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
Using the [morley] data frame, generate a grouped boxplot where _Speed_ is grouped by _Expt_. Set: 

* The _main_ title to "Morley Experiment" 
* The color to _rainbow(5)_
...
Using the [cafe] data frame, generate a boxplot of _length_ when grouped by _meal_ to see if there is any difference in the length of the meal by the type of meal eaten (breakfast, lunch, dinner, other). Set: 

* The main title to "Activity 4.3: Grouped Boxplot"
* The color to _topo.colors(4)_
