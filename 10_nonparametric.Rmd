...
```{r ex="act10.01", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r ex="act10.01", type="sample-code"}
...
```{r ex="ex10.02", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="ex10.02", type="sample-code"}
# Calculate a Mann-Whitney U for disp when grouped by am in the mtcars data frame.


```

```{r ex="ex10.02", type="solution"}
...
```{r ex="act10.02", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r ex="act10.02", type="sample-code"}
