...
# These are numbered by the exercise number and a sequence within the exercise.
# The sequence number is not necessary if there is only one check.
ex20neq <- "Check the density plot settings to be sure they match the requirement."
ex21neq <- "Check that the density plot is using the USJudgeRatings$INTG vector."
ex22neq <- "Check that main is US Judge Ratings."
ex23neq <- "Check that xlab is Integrity Rating."
ex24neq <- "Check that ylab is Density"
ex25neq <- "Check that lwd is 2."
ex26neq <- "Check that col is blue4."

ex() %>%
  check_function("plot") %>%
  check_result() %>%
  check_equal(incorrect_msg = ex20neq)
...
Complete the deliverables in this lab and consolidate the responses into a single document. Name the document with your name and "Lab 8," like "George Self Lab 8" and submit that document for grade.
