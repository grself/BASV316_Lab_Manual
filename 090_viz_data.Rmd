...
Using the [cafe] data frame, create a simple plot with _bill_ on the y-axis, _length_ on the x-axis, and a line of best fit to see if there is a relationship between the length of the meal and the bill. The plot should meet these specifications:
