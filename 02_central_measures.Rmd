...
* Lines 2-4: calculate the trimmed mean by including "trim=0.15" in the `mean` function. Line 2 trims 15% from each end of the _rivers_ vector and Line 3 trims 25%.

<span style="background-color:#ffff99;font-style:italic;">Note: this demonstration contains six examples of finding the trimmed mean.</span>

<span style="background-color: #ffff99; font-style: italic;">This demonstration contains six different examples of finding the trimmed mean.</span>
