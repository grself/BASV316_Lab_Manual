...
* Lines 2-4: These display the ranges for three different variables in the [_trees_](/tutorials/9999-data-dict/index.html#trees) data frame.
* Lines 7-8: These lines are very similar to Lines 1-4 but use variables in the [_rock_](/tutorials/9999-data-dict/index.html#rock) data frame.

<span style="background-color: #ffff99; font-style: italic;">This demonstration contains five different examples of finding the range.</span>
...
Using the [_faithful_](/tutorials/9999-data-dict/index.html#faithful) data frame, find the range for _eruptions_.

```{r ex="ex03.01", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="ex03.01", type="sample-code"}
# Range for eruptions
...
```{r ex="ex03.01", type="solution"}

range(faithful$eruptions)

```

```{r ex="ex03.01", type="sct"}
...
Using the _cafe_ data frame, find the range for _age_. Include that answer in the deliverable document for this lab.

```{r ex="act03.01", type="pre-exercise-code"}

cafe <- read.csv('https://gself.com/cafe.csv')

```

```{r ex="act03.01", type="sample-code"}
...
* Lines 2-4: Display summary information for three different variables in the _trees_ data frame.
* Lines 7-10: Display summary information for four different variables in the _rock_ data frame.

<span style="background-color: #ffff99; font-style: italic;">This demonstration contains seven different examples of finding quartiles.</span>
...
### Skill Check: Quartiles

Using the [_USJudgeRatings_](/tutorials/9999-data-dict/index.html#usjudgeratings) data frame, find the summary for _WRIT_.

```{r ex="ex03.02", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="ex03.02", type="sample-code"}
...
```{r ex="ex03.02", type="solution"}

summary(USJudgeRatings$WRIT)

```

```{r ex="ex03.02", type="sct"}
...
### Activity 3.2: Quartiles Using Summary

Using the _cafe_ data frame, find the summary for _age_. Include the values for Q1 and Q3 in the deliverable document for this lab.

```{r ex="act03.02", type="pre-exercise-code"}

cafe <- read.csv('https://gself.com/cafe.csv')

```

```{r ex="act03.02", type="sample-code"}
# Using the cafe data frame, find the summary for age.
...
* Lines 2-4: Display inter-quartile range for three different variables in the _trees_ data frame.
* Lines 7-10: Display inter-quartile range for four different variables in the _rock_ data frame.

<span style="background-color: #ffff99; font-style: italic;">This demonstration contains seven different examples of find the inter-quartile range (IQR).</span>
...
### Skill Check: IQR (Inter-Quartile Range)

Using the [_swiss_](/tutorials/9999-data-dict/index.html#swiss) data frame, find the IQR for _Agriculture_.

```{r ex="ex03.03", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="ex03.03", type="sample-code"}
...
```{r ex="ex03.03", type="solution"}

IQR(swiss$Agriculture)

```

```{r ex="ex03.03", type="sct"}
...
### Activity 3.3: Inter-Quartile Range (IQR)

Using the _cafe_ data frame, find the inter-quartile-range (IQR) for _age_. Include that answer in the deliverable document for this lab.
...
* Lines 2-4: Display standard deviation for three different variables in the _trees_ data frame.
* Lines 7-10: Display standard deviation for four different variables in the _rock_ data frame.

<span style="background-color: #ffff99; font-style: italic;">This demonstration contains seven different examples of finding the standard deviation.</span>
...
### Skill Check: Standard Deviation

Using the [_stackloss_](/tutorials/9999-data-dict/index.html#stackloss) data frame, find the standard deviation for _Air.Flow_.

```{r ex="ex03.04", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r ex="ex03.04", type="sample-code"}
# Find the standard deviation for Air.Flow


```

```{r ex="ex03.04", type="solution"}

sd(stackloss$Air.Flow)

```

```{r ex="ex03.04", type="sct"}
...
### Activity 3.4: Standard Deviation

Using the _cafe_ data frame, find the standard deviation for _age_. Include the answer in the deliverable document for this lab.

```{r ex="act03.04", type="pre-exercise-code"}

cafe <- read.csv('https://gself.com/cafe.csv')

```

```{r ex="act03.04", type="sample-code"}
...
This tutorial described and calculated several measures of dispersion. The last tutorial described various types of [central measures](/tutorials/0020-central-measures/) and the next creates a [visualization](/tutorials/0040-boxplot/) of central measures and dispersion.
