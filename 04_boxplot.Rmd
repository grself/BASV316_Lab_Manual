...
```{r fig01, fig.dim=c(2.5,4.0), fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
```{r fig02, fig.dim=c(2.5,4.0), fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
<span style="background-color: #ffff99; font-style: italic;">This demonstration contains four different examples of generating a boxplot.</span>
...
```{r fig03, fig.dim=c(2.5,4.0), fig.align="center", fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
To determine what values _R_ used to generate a boxplot plot, the command `boxplot.stats(rock$shape)` is executed.


```{r demo02, echo=FALSE, message=FALSE, warnings=FALSE, results='asis', tut=FALSE}
...
```{r fig04, fig.dim=c(4.0, 4.0), fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
```{r fig05, fig.dim=c(2.5,4.0), fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
```{r fig06, fig.dim=c(4.0, 4.0), fig.align="center", echo=FALSE, message=FALSE, warnings=FALSE, tut=FALSE}
...
# Create a boxplot of the morley data where Speed is grouped by Expt.
...
ex34neq <- "Check that the rainbow color palette is chosen and 5 colors are specified."
