...
```{r 01.03, ex="ex01.01", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 01.04, ex="ex01.01", type="sample-code"}
# Set M to 15 + ( 37 * 2 )
...
```{r 01.05, ex="ex01.01", type="solution"}
...
```{r 01.07, ex="act01.01", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 01.08, ex="act01.01", type="sample-code"}
...
```{r 01.10, ex="ex01.02", type="pre-exercise-code"}

# No pre-exercise code for this exercise

```

```{r 01.11, ex="ex01.02", type="sample-code"}
...
```{r 01.12, ex="ex01.02", type="solution"}
...
```{r 01.14, ex="act01.02", type="pre-exercise-code"}

cafe <- read.csv('https://labs.basv316.com/cafe.csv')

```

```{r 01.15, ex="act01.02", type="sample-code"}
